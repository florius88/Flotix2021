...
{
    class CaducidadesViewModel : BaseViewModel
    {
        private static bool _panelLoading;
        private string _panelMainMessage = "Cargando la información necesaria para mostrar las caducidades.";
        private string _panelSubMessage = "Por favor, espere...";
        public CaducidadesViewModel()
        {
        }
